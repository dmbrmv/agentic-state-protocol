...
STANDARD_CAPABILITIES: dict[str, list[dict]] = {
    "python": [
        ...
        },
        {
            ...
            "severity": "low",
            "keywords": ["format", "black", "ruff", "style"],
        ...
        },
        {
            ...
            "description": "Data quality and schema validation for scientific pipelines",
            "severity": "high",
            "keywords": ["data", "validation", "schema", "quality", "pandera"],
            "preferred_types": ["skills", "commands"],
            "covered_by": ["data_audit", "pandera", "great-expectations"],
        },
        {
            "category": "reproducibility",
            "description": "Experiment reproducibility and environment tracking",
            "severity": "medium",
            "keywords": ["reproducibility", "seed", "environment", "conda", "lock"],
            "preferred_types": ["skills"],
            "covered_by": ["conda", "conda-lock", "environment"],
        },
        {
            "category": "geospatial_checks",
            "description": "Geospatial data integrity and CRS validation",
            "severity": "high",
            "keywords": ["geospatial", "crs", "raster", "vector", "projection", "gdal"],
            "preferred_types": ["skills", "commands"],
            "covered_by": ["data_audit", "rasterio", "geopandas", "gdal"],
        },
    ],
}
        ...
        "webapp": [
            {
                ...
                "check_frameworks": ["fastapi", "django", "flask"],
            },
            {
...
def _find_quality_gaps(context: ProjectContext) -> list[CapabilityGap]:
    ...
    if context.primary_language in typed_languages and not context.type_checking:
        gaps.append(CapabilityGap(
            ...
            severity="medium",
            source="analysis",
            keywords=["type", "typing", "mypy", "pyright", "strict"],
            preferred_types=["hooks"],
        ))
